...
async function main() {
    ...
    console.log('🎲 Fulfilling specific VRF request for:', lotteryAddress)
    const [deployer] = await ethers.getSigners()

    // Actual parameters from the draw transaction 0xa6e6352c3b81971b8a6ef6c2c870173e6add9db1b9cbea33270e99df611fdb54
    const requestId = 48n // 0x30
    const round = 10436267n // 0x9f3eab
    const pubKeyHash = '0xed6820c99270b1f84b30b0d2973ddd6a0f460fe9fc9dcd867dd909c1c1ac20f9'
    ...
    try {
        ...
        if (fulfillEvent) {
            ...
            if (callbackSuccess) {
                ...
                console.log('Final lottery state:', ['Nonexistent', 'Purchase', 'DrawPending', 'Dead'][gameInfo.state])

                if (gameInfo.state === 1n) {
                    console.log('🎉 New game has started! The lottery is now accepting tickets.')
                }
            }
        }
