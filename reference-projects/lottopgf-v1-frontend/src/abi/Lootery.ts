export const LOOTERY_ABI = [
  ...
  },
  {
    ...
    name: "InsufficientOperationalFunds",
    type: "error",
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: "PrizeTokenWithdrawalNotAllowed",
    type: "error",
  },
  {
    inputs: [
    ...
    inputs: [
      {
        components: [
          ...
          {
            internalType: "address",
            name: "ticketSVGRenderer",
            type: "address",
          },
        ],
        internalType: "struct ILootery.InitConfig",
        name: "initConfig",
        type: "tuple",
      },
    ],
